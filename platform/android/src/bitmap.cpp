...
void Bitmap::CompressFormat::registerNative(jni::JNIEnv& env) {
    _class = *jni::Class<CompressFormat>::Find(env).NewGlobalRef(env).release();
}

jni::Class<Bitmap::CompressFormat> Bitmap::CompressFormat::_class;

jni::Object<Bitmap::CompressFormat> Bitmap::CompressFormat::Create(jni::JNIEnv& env, Value value) {
    switch (value) {
    case JPEG:
        return _class.Get(env,
                          jni::StaticField<CompressFormat, jni::Object<CompressFormat>>(env, _class, "JPEG"));
    case PNG:
        return _class.Get(env,
                          jni::StaticField<CompressFormat, jni::Object<CompressFormat>>(env, _class, "PNG"));
    case WEBP:
        return _class.Get(env,
                          jni::StaticField<CompressFormat, jni::Object<CompressFormat>>(env, _class, "WEBP"));
    default:
        throw std::runtime_error("invalid enum value for Bitmap.CompressFormat");
    }
}
...
void Bitmap::registerNative(jni::JNIEnv& env) {
    ...
    CompressFormat::registerNative(env);
}
...
jni::jboolean Bitmap::Compress(jni::JNIEnv& env,
                               jni::Object<Bitmap> obj,
                               jni::Object<CompressFormat> format,
                               jni::jint quality,
                               jni::Object<OutputStream> stream) {
    using Signature =
        jni::jboolean(jni::Object<CompressFormat>, jni::jint, jni::Object<OutputStream>);
    auto method = _class.GetMethod<Signature>(env, "createBitmap");
    return obj.Call(env, method, format, quality, stream);
}
